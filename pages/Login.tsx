...
export const Login: React.FC = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Verifica se já tem perfil para decidir o destino
      if (StorageService.getProfile()) {
        navigate('/');
      } else {
        navigate('/onboarding');
      }
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-24 bg-background">
        <div className="w-full max-w-sm space-y-8">
            ...
            <p className="mt-10 text-center text-sm text-muted-foreground">
                Não tem uma conta?{' '}
                <a href="#" className="font-semibold leading-6 text-primary hover:text-brand-500 transition-colors">
                    Criar conta grátis
                </a>
            </p>
